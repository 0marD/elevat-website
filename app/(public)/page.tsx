...
export const metadata: Metadata = {
  title: 'ÉLEVA. — Agencia de Viajes de Lujo en México | Viajes Personalizados',
  description: 'Agencia de viajes de lujo en México. Diseñamos itinerarios personalizados a Los Cabos, Riviera Maya, Europa y el mundo. Cotización gratuita en 48 horas.',
  keywords: 'agencia de viajes lujo México, viajes personalizados México, paquetes turísticos premium, viajes Guadalajara, luna de miel México, viajes de lujo Caribe, itinerarios personalizados',
  alternates: { canonical: 'https://elevaviajes.shop' },
  openGraph: {
    title: 'ÉLEVA. — Agencia de Viajes de Lujo en México',
    description: 'No vendemos viajes. Diseñamos experiencias únicas y personalizadas.',
    url: 'https://elevaviajes.shop',
    type: 'website',
    locale: 'es_MX',
    siteName: 'ÉLEVA. Viajes de Autor',
  },
  twitter: {
...
const organizationJsonLd = {
  ...
  '@type': 'TravelAgency',
  name: 'ÉLEVA. Viajes de Autor',
  description: 'Agencia de viajes de lujo en México especializada en experiencias de viaje completamente personalizadas. Atención personalizada desde el primer mensaje.',
  url: 'https://elevaviajes.shop',
  logo: 'https://elevaviajes.shop/favicon/android-chrome-512x512.png',
  image: 'https://elevaviajes.shop/favicon/android-chrome-512x512.png',
  contactPoint: {
    '@type': 'ContactPoint',
...
export default async function HomePage() {
  const destacados = (await getActivos()).slice(0, 3).map(serialize)
    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          <div className="section-label mb-8 animate-fade-in">Agencia de viajes de autor · México</div>

          <h1 className="display-heading mb-6 animate-slide-up animate-delay-100"
            style={{ fontSize: 'clamp(56px, 10vw, 110px)', letterSpacing: '10px' }}>
            ÉLEVA<span className="text-dorado">.</span>
          </h1>

          <span className="gold-line mx-auto mb-8 block animate-fade-in animate-delay-200" />

          <p className="text-crema/60 mb-12 max-w-xl mx-auto leading-loose animate-fade-in animate-delay-300"
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          {destacados.length === 0 && (
            <div className="col-span-3 text-center text-plata text-sm py-20">
              Pronto agregaremos nuestros destinos destacados.
            </div>
          )}
        </div>
      </section>
